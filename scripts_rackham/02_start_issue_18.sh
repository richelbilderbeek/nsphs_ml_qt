...
# Usage: 
#
#   ./nsphs_ml_qt/scripts_rackham/02_start_issue_18.sh
#   sbatch ./nsphs_ml_qt/scripts_rackham/02_start_issue_18.sh
#
...
#SBATCH --mem=16G
#SBATCH --job-name=02_start_issue_18
#SBATCH --output=02_start_issue_18.log
...
experiment_params_filename="{datadir}experiment_params.csv"
