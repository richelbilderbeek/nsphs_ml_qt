...
jobid_29=$(sbatch -A snic2021-22-624 --dependency=afterany:$jobid_25 --output=29_zip_${unique_id}.log           ./nsphs_ml_qt/scripts_rackham/29_zip.sh                    $gcae_experiment_params_filename | cut -d ' ' -f 4)
